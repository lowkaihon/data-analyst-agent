...
const RequestSchema = z.object({
  ...
  // NEW: Accept exploration summary from agentic exploration
...
export async function POST(req: Request) {
  try {
    ...
    const { question, schema, sqlHistory, charts, explorationSummary } = RequestSchema.parse(body)
...
The above summary was generated by an agentic AI exploration that analyzed the dataset.
Use this summary as additional context but still base your report on the actual SQL query results below.
`
    : ""
}
